...
const zh: Dict = {
  ...
  "img.brand": "赢学联盟 · RIFT PETTIFOGGER",
  "img.docType": "判 决 书",
  "img.caseNo": "（{y}）赢学第 {n} 号",
  "img.finds": "本 院 认 定",
  "img.evidence": "证 据 链",
  "img.rule2Line": "共同对手：{via}",
  "img.tallyGame": "按小局计",
  "img.window": "取证 {start} ～ {end}",
  "img.windowTo": "取证截至 {end}",
  "img.therefore": "∴ 综上所述：{a} ＞ {b}，铁证如山",
  "img.sealArc": "赢学联盟",
  "img.sealBottom": "判案专用章",
  "img.stamp": "证据确凿",
  "img.cta": "不服来辩 ▸ {url}",
  "img.disclaimer": "娱乐向 · 论据 ≠ 真理 · 反向结论可能同时成立",
  "img.source": "数据 Oracle's Elixir · 判于 {date}",
...
const en: Dict = {
  ...
  "arg.image": "Make Image",

  "share.title": "Share Verdict Image",
  "share.light": "Light",
  "share.dark": "Dark",
  ...
  "img.brand": "RIFT PETTIFOGGER · WINOLOGY LEAGUE",
  "img.docType": "OFFICIAL VERDICT",
  "img.caseNo": "Case No. {y}-{n}",
  "img.finds": "THE COURT FINDS",
  "img.evidence": "CHAIN OF EVIDENCE",
  "img.rule2Line": "Common opponent: {via}",
  "img.tallyGame": "game-level tally",
  "img.window": "Evidence {start} – {end}",
  "img.windowTo": "Evidence through {end}",
  "img.therefore": "∴ Therefore {a} ＞ {b}.",
  "img.sealArc": "赢学联盟",
  "img.sealBottom": "判案专用章",
  "img.stamp": "CASE CLOSED",
  "img.cta": "Objection? Run the data ▸ {url}",
  "img.disclaimer": "For fun · arguments ≠ truth · the reverse may also hold",
  "img.source": "Data: Oracle's Elixir · adjudicated {date}",
